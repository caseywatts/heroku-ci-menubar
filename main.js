...
app.on('ready', function(){
  ...
  function parseBuildData(sampleData) {
    return {
      status: sampleData[1].data['status'],
      actorEmail: sampleData[1].data['actor_email'],
      commitBranch: sampleData[1].data['commit_branch'],
      number: sampleData[1].data['number'],
      url: 'http://google.com/'
    };
  }
